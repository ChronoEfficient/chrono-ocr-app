...
echo "=== Deploying chrono-ocr-api to PREPROD ==="
gcloud config set project scaffold-489910

gcloud run deploy chrono-ocr-api-preprod --source=. --project=scaffold-489910 --region=africa-south1 --platform=managed --allow-unauthenticated \
